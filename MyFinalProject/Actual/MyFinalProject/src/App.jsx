  ...
  return (
    <div className="container">
      ...
      <div className='row mt-4' id='searchStudents'>
        ...
        <div className='col-md-4'>
          <input type='text' className='form-control' placeholder='Firestar' onChange={(e) => setKeyWords(e.currentTarget.value)} value = {keywords} />
        </div>
        <div className='col-md-4'>
        ...
        <div className='col-md-4'>
          <button type='button' className='btn btn-primary btn-lg' onClick={searchStudents}>Search Cats &nbsp;<FontAwesomeIcon icon={faSearch}/></button>
        </div>
      </div>
    </div>
